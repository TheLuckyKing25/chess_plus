...
var placement_tree: Dictionary = {
	...
	"Castling": {
			...
			"Checked Close OLD_MOVEMENT_CLASS": "r3k2r/ppp1p1pp/8/3Q1Q2/3q1q2/8/PPP1P1PP/R3K2R w KQkq - 0 1",
			"Checked Far OLD_MOVEMENT_CLASS": "r3k2r/pp1ppp1p/8/2Q3Q1/2q3q1/8/PP1PPP1P/R3K2R w KQkq - 0 1",
			},
