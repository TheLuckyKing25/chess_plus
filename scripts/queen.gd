...
var move_rules: Array[Dictionary] = [
	{"move_flags": Movement|Threaten, "distance": QUEEN_MOVE_DISTANCE, "direction": (NORTH + direction_parity) % 8 },
	{"move_flags": Movement|Threaten, "distance": QUEEN_MOVE_DISTANCE, "direction": (NORTHEAST + direction_parity) % 8},
	{"move_flags": Movement|Threaten, "distance": QUEEN_MOVE_DISTANCE, "direction": (EAST + direction_parity) % 8 },
	{"move_flags": Movement|Threaten, "distance": QUEEN_MOVE_DISTANCE, "direction": (SOUTHEAST + direction_parity) % 8 },
	{"move_flags": Movement|Threaten, "distance": QUEEN_MOVE_DISTANCE, "direction": (SOUTH + direction_parity) % 8 },
	{"move_flags": Movement|Threaten, "distance": QUEEN_MOVE_DISTANCE, "direction": (SOUTHWEST + direction_parity) % 8 },
	{"move_flags": Movement|Threaten, "distance": QUEEN_MOVE_DISTANCE, "direction": (WEST + direction_parity) % 8 },
	{"move_flags": Movement|Threaten, "distance": QUEEN_MOVE_DISTANCE, "direction": (NORTHWEST + direction_parity) % 8 },
]

var moveset: Dictionary = {"move_flags": Branch, "branches": []}

#func construct_complete_moveset():
	#for rule in queen_move_rules:
...
#func calculate_moveset():
	#for direction in queen.direction:
		#var path: Array[Vector2i] = [] 
		#for distance in range(1,queen.distance):
...
#
		#for distance in range(1,queen.distance+1):
