...
var move_rules: Array[Dictionary] = [
	{"move_flags": Movement|Threaten, "distance": ROOK_MOVE_DISTANCE, "direction": (NORTH + direction_parity) % 8 },
	{"move_flags": Movement|Threaten, "distance": ROOK_MOVE_DISTANCE, "direction": (EAST + direction_parity) % 8 },
	{"move_flags": Movement|Threaten, "distance": ROOK_MOVE_DISTANCE, "direction": (SOUTH + direction_parity) % 8 },
	{"move_flags": Movement|Threaten, "distance": ROOK_MOVE_DISTANCE, "direction": (WEST + direction_parity) % 8 },
]
...
#func calculate_complete_moveset():
	...
	#for direction in rook.direction:
		#var max_outward_path: Array[Tile] = []
#
		#for distance in range(1,rook.distance+1):
