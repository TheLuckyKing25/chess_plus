...
@onready var move_rules: Array[Dictionary] = [
	{"move_flags": Game.MoveType.Movement|Game.MoveType.Threaten, "distance": ROOK_MOVE_DISTANCE, "direction": (Game.Direction.NORTH + direction_parity) % 8 },
	{"move_flags": Game.MoveType.Movement|Game.MoveType.Threaten, "distance": ROOK_MOVE_DISTANCE, "direction": (Game.Direction.EAST + direction_parity) % 8 },
	{"move_flags": Game.MoveType.Movement|Game.MoveType.Threaten, "distance": ROOK_MOVE_DISTANCE, "direction": (Game.Direction.SOUTH + direction_parity) % 8 },
	{"move_flags": Game.MoveType.Movement|Game.MoveType.Threaten, "distance": ROOK_MOVE_DISTANCE, "direction": (Game.Direction.WEST + direction_parity) % 8 },
]
