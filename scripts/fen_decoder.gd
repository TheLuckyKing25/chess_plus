...
func set_active_player():
	match FEN_board_position.active_player:
		...
		"b":
			Player.current = GameData.player.black


func set_castling_availability():
	GameData.player.white.pieces["King"][0].data.set_meta("is_castling_kingside_valid", false)
	GameData.player.white.pieces["King"][0].data.set_meta("is_castling_queenside_valid", false)
	GameData.player.black.pieces["King"][0].data.set_meta("is_castling_kingside_valid", false)
	GameData.player.black.pieces["King"][0].data.set_meta("is_castling_queenside_valid", false)
	for character in FEN_board_position.castling_availability:
		match character:
			"K":
				GameData.player.white.pieces["King"][0].data.set_meta("is_castling_kingside_valid", true)
			"Q":
				GameData.player.white.pieces["King"][0].data.set_meta("is_castling_queenside_valid", true)
			"k":
				GameData.player.black.pieces["King"][0].data.set_meta("is_castling_kingside_valid", true)
			"q":
				GameData.player.black.pieces["King"][0].data.set_meta("is_castling_queenside_valid", true)
