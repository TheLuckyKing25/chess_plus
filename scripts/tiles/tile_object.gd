...
static var selection_mode: TileSelectionMode = TileSelectionMode.SINGLE
...
func _on_tile_clicked(tile: TileObject) -> void:
	if selection_mode == TileSelectionMode.MULTIPLE:
		_customization_tile_select()
	elif selection_mode == TileSelectionMode.SINGLE:
